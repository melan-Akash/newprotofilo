    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#top">
                    <img src={navLogoLight} alt="Melan Akash" className="w-28 cursor-pointer mr-14 dark:hidden" />
                    <img src={navLogoDark} alt="Melan Akash" className="w-28 cursor-pointer mr-14 hidden dark:block" />
                </a>
                ...
                {/* -- ----- mobile menu ------  -- */}
                <ul ref={sideMenuRef} className="flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-slate-100 transition duration-500 font-Ovo dark:bg-darkHover dark:text-white">
