                ...
                {projects.slice(0, visibleCount).map((project) => {
                    ...
                    return (
                        <div
                            ...
                            className="aspect-[4/3] sm:aspect-square bg-no-repeat bg-cover bg-top rounded-2xl relative cursor-pointer group shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 overflow-hidden border border-gray-200 dark:border-white/10"
