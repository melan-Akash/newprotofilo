                    ...
                    <div className="flex flex-wrap items-center gap-3.5 pt-2">
                        {project.live && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-2.5 px-7 py-3 rounded-full bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-medium text-sm shadow-lg shadow-sky-500/25 active:scale-95 transition-all"
                            >
                        ...
                        {project.github && (
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-white dark:bg-[#0c182d] border border-gray-300 dark:border-white/20 text-gray-800 dark:text-white font-medium text-sm hover:bg-gray-100 dark:hover:bg-white/10 active:scale-95 transition-all shadow-sm"
                            >
                            ...
                            {projectImages.length > 1 && (
                                <>
                                    <button
                                        ...
                                        className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 hover:bg-black/85 text-white flex items-center justify-center backdrop-blur-md opacity-80 hover:opacity-100 transition shadow-lg border border-white/20 active:scale-95"
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 hover:bg-black/85 text-white flex items-center justify-center backdrop-blur-md opacity-80 hover:opacity-100 transition shadow-lg border border-white/20 active:scale-95"
                                        title="Next Image"
                                    >
                                        ›
                                    </button>
                            ...
                            {otherProjects.map((other) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="aspect-[4/3] sm:aspect-square bg-no-repeat bg-cover bg-top rounded-2xl relative cursor-pointer group shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 overflow-hidden border border-gray-200 dark:border-white/10"
